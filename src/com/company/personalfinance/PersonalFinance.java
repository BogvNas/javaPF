package com.company.personalfinance;
...
public class PersonalFinance {
    ...
    private static void testModel() throws ModelException {
        ...
        Currency c1 = new Currency("Рубль", "RUR", 1, true, true);
        ...
        transactions.add(new Transaction(ac2, article3, 25000, new Date((new Date()).getTime() - (long) 86400 * 1000 * 30)));
        transactions.add(new Transaction(ac3, article5, 1000, new Date((new Date()).getTime() - (long) 86400 * 1000 * 30)));
        ...
        for (int i = 0; i < 50; i++){
            ...
            double tempAmount = Math.random() * (double)(Math.random() * (-1000));
            Date tempDate = new Date((long) (new Date().getTime() - (long) 86400 * 1000 * 30 * Math.random()));
    ...
    private static void init() {
        ...
        try {
            graphicsEnvironment.registerFont(Font.createFont(Font.TRUETYPE_FONT, Settings.FONT_ROBOTO_LIGHT));
