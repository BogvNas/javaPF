...
final public class Style {
    ...
    public static final Color COLOR_EXP = new Color(150, 0, 0);
    public static final Color COLOR_INCOME = new Color(0, 100, 0);
    public static final Object COLOR_ON = Color.BLACK;
    public static final Object COLOR_OFF = new Color(170, 170, 170);
    ...
    public static final Border BORDER_FILTER_PANEL = new EmptyBorder(5, 0, 7, 0);
    ...
    public static final Object ICON_PANEL_STATISTICS = new ImageIcon("images/statistics.png");;
}
