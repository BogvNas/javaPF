...
final public class Text {
    ...
    public static void init(){
        ...
        data.put("ERROR_DATE_FORMAT","Неккоректный формат даты!");
        ...
        data.put("ERROR_NO_BASE_CURRENCY","Необходима базовая валюта! Установите сначала этот параметр в другой валюте, далее этот" +
                "посчитается автоматически!");

        data.put("YES", "Да");
        data.put("NO", "Нет");

        data.put("MENU_FILE","Новый");
        data.put("MENU_EDIT","Правка");
        data.put("MENU_VIEW","Вид");
        data.put("MENU_HELP","Помощь");
        ...
        data.put("FC_LIST", "Список");//VIEW
        data.put("FC_NAME", "Таблица");
        data.put("FC_SIZE", "Имя");
        data.put("FC_TABLE", "Размер");//
        ...
        data.put("ABOUT", "<body style='font-size: 120%; text-align: center; width: 350px;'>" +
                ...
                "<br /><a style='font-weight: bold;' href = https://vk.com/n.k_petrov> https://vk.com/n.k_petrov</a></p>"+
                "<p>С уважением Петров Николай!</p>"+
